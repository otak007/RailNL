...
Als alle connecties kritiek zijn dan moet je in connections.py critical_value op 1 zetten en als niet alle connecties kritiek zijn dan moet je die op 0 zetten.
