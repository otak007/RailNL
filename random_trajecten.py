...
class Map(object):
    ...
    def choose_trajecten(self):
        ...
        trajecten = self.random_traject(num_trajects)
    ...
    def new_traject(self, name, station):
        ...
        return self.travel(traject, start_station)
    ...
    def travel(self, traject, station):
        ...
        if traject.total_time < max_min:
            ...
            # Travel again with
            self.travel(traject, next_station)
